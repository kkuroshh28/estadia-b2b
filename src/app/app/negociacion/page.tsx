 ...
 */
export default function ModuloNegociacion() {
  const neg = NEGOCIACION_DEMO;
  const prop = propiedadPorId(neg.propiedadId);
  ...
  const [propuesta, setPropuesta] = useState(5_100_000);
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-bruma">
            {prop.nombre} · {neg.fechas.desde} → {neg.fechas.hasta} · {neg.noches} noches
          </p>
        </div>
